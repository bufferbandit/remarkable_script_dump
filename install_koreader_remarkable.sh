# Koreader install script I modified to be able to set the framebuffer versions and koreader version
...
FRAMEBUFFER_VERSION="v0.0.26"
KOREADER_VERSION="v2022.07"

APPDIR=${APPDIR:-/home/root/apps}
REPOURL="https://raw.githubusercontent.com/ddvk/remarkable-autoinstall/master/rm2"
RM2FBREPO="https://github.com/ddvk/remarkable2-framebuffer/releases/download/${FRAMEBUFFER_VERSION}"
